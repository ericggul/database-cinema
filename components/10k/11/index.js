...
export default function SceneTransformerLightning() {
  ...
  const handleBatchGenerate = async () => {
    ...
    for (let i = 0; i < plan.length; i += 1) {
      ...
      try {
        ...
        const response = await fetch("/api/replicate/transform-lightning", {
          method: "POST",
  ...
  return (
    <Container>
      <Title>Scene Time Machine · Replicate (Lightning 4-step)</Title>
