...
export default function SceneTransformerRealVis() {
  ...
  const handleBatchGenerate = async () => {
    ...
    for (let i = 0; i < plan.length; i += 1) {
      ...
      try {
        ...
        const response = await fetch("/api/replicate/transform-realvis", {
          method: "POST",
  ...
  return (
    <Container>
      <Title>Scene Time Machine · Replicate (RealVis XL Turbo)</Title>
